...
def read_imdb(dir='/mnt/bn/occupancy3d/workspace/dataset/aclImdb', split='pos', is_train=True):
...
def read_imdb_words(dir='/mnt/bn/occupancy3d/workspace/dataset/aclImdb',
                    split='pos',
                    is_train=True,
                    n_files=1000):
    subdir = 'train' if is_train else 'test'
...
def read_imdb_vocab(dir='/mnt/bn/occupancy3d/workspace/dataset/aclImdb'):
